...
<head>
    ...
    <link href="<%= cp %>/resources/css/local.css" rel="stylesheet" />
				...
				<div class="col-lg-9" style="margin-bottom: 50px;">
					...
					<div ng-controller="MainCtrl">
		           	...
		           	<div style="text-align: right; margin-top: 10px;">
		           		<button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modalAdd">추가</button>
		           		<!-- <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modalAdd">수정</button>  -->
