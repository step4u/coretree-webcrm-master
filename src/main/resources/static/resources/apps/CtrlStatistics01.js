	/* 통화내역 */
	angular.module('app')
	.controller('CtrlStatistics01', ['$scope', '$http', 'uiGridConstants', function ($scope, $http, uiGridConstants) {
		...
		$scope.gridOptions = {
				...
				columnDefs: [
			    		      { displayName: '시간', field: 'timerange', headerCellClass: 'white', cellClass: 'grid-cell' },
...
*/
		...
		$scope.getPage = function() {
	    	...
	    	console.log(angular.toJson(scondition));
	    	
			$http({
				method: "POST",
				url: "/statistics01/get/all",
				data: scondition
