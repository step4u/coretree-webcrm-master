	// 고객리스트
	angular.module('app')
	.controller('CtrlCustomer', ['$scope', '$http', 'i18nService', '$log', '$timeout', 'uiGridConstants', '$stateParams', '$uibModal'
	                             , function ($scope, $http, i18nService, $log, $timeout, uiGridConstants, $stateParams, $uibModal) {
		...
		*/
		...
		$scope.open = function (size) {
			var modalInstance = $uibModal.open({
				...
				backdrop: false,
				keyboard: false,
				templateUrl: '/view/ModalCustomer.html',
				controller: 'CtrlGroups',
				size: size,
				resolve: {
					items: function () {
						return $scope.items;
